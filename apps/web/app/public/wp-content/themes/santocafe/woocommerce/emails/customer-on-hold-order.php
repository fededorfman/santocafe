<?php
/**
 * Customer on-hold order email — Santo Café override.
 *
 * Pedido en espera de confirmación de pago. Conserva los hooks dinámicos de
 * WooCommerce y adapta el copy a la voz de marca (español de Chile).
 *
 * @see woocommerce/templates/emails/customer-on-hold-order.php
 * @package santocafe
 * @version 10.4.0
 */
...
<p>Recibimos tu pedido <strong>#<?php echo esc_html( $order->get_order_number() ); ?></strong> y quedó en espera hasta confirmar tu pago. En cuanto se acredite, comenzamos a prepararlo.</p>
