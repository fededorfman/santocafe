 ...
 *
 * Santo Café override: encabezados de columna acortados a "Producto", "Uds." y
 * "$" para que entren en el ancho del email. Resto idéntico al core de WC.
 *
...
<div style="margin-bottom: <?php echo $email_improvements_enabled ? '24px' : '40px'; ?>;">
	<table class="td font-family <?php echo esc_attr( $order_table_class ); ?>" cellspacing="0" cellpadding="6" style="width: 100%;" border="0">
		<?php if ( ! $block_email_editor_enabled ) : ?>
		<thead>
			<tr>
				<th class="td text-align-left" scope="col"><?php echo 'Producto'; ?></th>
				<th class="td text-align-<?php echo esc_attr( $order_quantity_text_align ); ?>" scope="col"><?php echo 'Uds.'; ?></th>
				<th class="td text-align-<?php echo esc_attr( $order_total_text_align ); ?>" scope="col"><?php echo '$'; ?></th>
			</tr>
		</thead>
		<?php endif; ?>
		<tbody>
